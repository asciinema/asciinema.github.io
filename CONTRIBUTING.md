...
- Validate your changes with `mkdocs build --strict`.
- Typo and small wording fixes are always welcome and can go straight to a
  pull request, no prior discussion needed.
- Include a screenshot for layout, theme or embedded-player changes.
